...
function validateForm(name,category, description, price, image) {
...
function AddData() {
  ...
  if (validateForm(name,category, description, price, image) == true) {
  ...
  if (sortedItem.length === 0) {
    ...
    sortedItem.forEach(function (element, index) {
      html += `<div class'card-body'>
       ...
       <div class='card-body'>
       <h5 class='card-title'>Id #${element.id} </h5>
       <img src="${element.image}" class='card-img-top' alt='Image' height="100px" width="100px">
       </div>
       <ul class='list-group list-group-flush'>
       <li class='list-group-item'>Product :  ${element.name}  </li>
       <li class='list-group-item'>Category :  ${element.category}  </li>
