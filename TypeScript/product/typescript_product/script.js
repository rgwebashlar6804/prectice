...
function cart(productList) {
    ...
    document.querySelectorAll('.view-more').forEach(button => {
        button.addEventListener('click', () => {
            var _a;
            let descriptionSpan = (_a = button.parentNode) === null || _a === void 0 ? void 0 : _a.querySelector('.more');
...
function filterProduct(sortvalue) {
    ...
    let productList = (_a = JSON.parse(localStorage.getItem("productList"))) !== null && _a !== void 0 ? _a : null;
    let sortedProduct = (_b = JSON.parse(localStorage.getItem("sortedProduct"))) !== null && _b !== void 0 ? _b : null;
